          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              ...
              >
                ...
                {/* Education badge for fifth project (MedClass) */}
                {index === 4 && (
                  <div className="absolute -top-3 -right-3 z-10">
                    <div className="bg-gradient-to-r from-blue-400 to-indigo-500 text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg transform rotate-12 animate-bounce">
                      📚 Education
                    </div>
                  </div>
                )}
                
                {/* Awareness badge for sixth project (Pink out Sunday) */}
                {index === 5 && (
                  <div className="absolute -top-3 -right-3 z-10">
                    <div className="bg-gradient-to-r from-pink-400 to-rose-500 text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg transform rotate-12 animate-bounce">
                      💗 Awareness
                    </div>
                  </div>
                )}
