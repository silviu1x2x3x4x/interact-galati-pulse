...
const HeroSection = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute bottom-20 right-10 w-16 h-16 bg-red-500/20 rounded-full"></div>
      <div className="absolute top-1/2 left-5 w-12 h-12 bg-yellow-400/20 rounded-full"></div>
    </div>
  );
};
